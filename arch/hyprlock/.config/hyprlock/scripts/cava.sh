...
player="spotify,ncspot,%any"
VIS_BARS=28             # Width (number of columns) - Narrower by 20 (10 each side)
MAX_HEIGHT=9            # Height (number of levels)
COLOR_ACTIVE="#882B9E"   # Purple active bars
COLOR_DIM="#882B9E33"   # Purple dim transparent
