# Generated by Powerlevel10k configuration wizard on 2026-04-18 at 10:15 UTC.
...
# 24h time, 2 lines, disconnected, sparse, concise, instant_prompt=verbose.
...
() {
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND='%F{039}'
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND='%F{039}'
